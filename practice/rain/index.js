...
export default () => {  
    ...
    //################################################################ rain ###########################################################
    {
        ...
        const material= new THREE.ShaderMaterial({
            ...
            fragmentShader: `\
                ...
                void main() {
                    ...
                    gl_FragColor = sphere;
                    gl_FragColor *= 0.7;
                    gl_FragColor.a *= 0.5 - abs(vUv.y - 0.5);
        ...
        function addInstancedMesh() {
            const geometry2 = new THREE.PlaneGeometry( 0.03, 0.7 );
            ...
            for (let i = 0; i < particleCount; i++) {
                positionsAttribute.setXYZ(i, localPlayer.position.x + (Math.random() - 0.5) * 100, (Math.random()) * 300, localPlayer.position.z + (Math.random() - 0.5) * 100);
                info.velocity[i] = new THREE.Vector3(0, -0.58, -0.1);
            ...
            if (mesh) {
                ...
                for (let i = 0; i < particleCount; i++){
                    if(positionsAttribute.getY(i) < 0){
                        positionsAttribute.setXYZ(i, localPlayer.position.x + (Math.random() - 0.5) * 100, localPlayer.position.y + 100, localPlayer.position.z + (Math.random() - 0.5) * 100);
                    }
                    else{
