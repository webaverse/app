...
physicsManager.getPath = (start, dest, hx, hy, hz, p, q, maxIterDetect, ignorePhysicsIds) => {
  return physx.physxWorker.getPathPhysics(physx.physics, start, dest, hx, hy, hz, p, q, maxIterDetect, ignorePhysicsIds);
};
