...
physicsManager.cutMesh = (positions,numPositions,faces,numFaces,position,quaternion,scale) => physx.physxWorker.doCut(positions,numPositions,faces,numFaces,position,quaternion,scale);
