...
var ASM_CONSTS = {
  34204: () => { console.log('getComputedBiomeHeight error'); },  
 34253: () => { console.log('error 1'); },  
 34281: () => { console.log('error 3'); },  
 34309: () => { console.log('error 4'); },  
 34337: ($0, $1, $2, $3, $4, $5) => { console.log('zero derivative', $0, $1, $2, $3, $4, $5); },  
 34397: ($0, $1, $2, $3, $4, $5) => { console.log('zero derivative', $0, $1, $2, $3, $4, $5); },  
 34457: () => { console.log('task queue destructor'); },  
 34499: ($0, $1) => { handleResult($0, $1); }
};
