...
var parcelRequire = function(e, r, t, n) {
    ...
    "A2wr": [function(require, module, exports) {
        let e;
        module.exports = "function" == typeof queueMicrotask ? queueMicrotask : t => (e || (e = Promise.resolve())).then(t).catch(e => setTimeout(() => {
            throw e
        }, 0));
    }, {}],
    ...
    "hwMU": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.authorization = c, exports.authorizations = s, exports.build = i, exports.getAccount = p, exports.getEvents = f, exports.getLatestBlock = l, exports.getTransactionStatus = d, exports.limit = m, exports.param = g, exports.params = v, exports.payer = b, exports.ping = P, exports.ref = I, exports.script = x, exports.transaction = j, Object.defineProperty(exports, "isBad", {
            enumerable: !0,
            get: function() {
                return e.isBad
            }
        ...
        }), exports.resolveSignatures = exports.resolveParams = exports.resolveAccounts = exports.resolve = exports.proposer = void 0;
        var e = require("@onflow/interaction"),
            r = require("@onflow/send"),
            n = require("@onflow/decode"),
            t = require("@qvvg/templar"),
            o = require("@onflow/encode");

        function i(r) {
            return void 0 === r && (r = []), (0, e.pipe)((0, e.interaction)(), r)
        }
        var u = e.pipe;
        ...
        function s(r) {
            return void 0 === r && (r = []), (0, e.pipe)(r.map(function(r) {
                return (0, e.makeAuthorizer)(a({}, "function" == typeof r ? {
                    resolve: r
                } : r, {
                    role: {
                        authorizer: !0
        ...
        function p(r) {
            return (0, e.pipe)([e.makeGetAccount, function(n) {
                return n.accountAddr = r, (0, e.Ok)(n)
            }])
        }

        function f(r, n, t) {
            return (0, e.pipe)([e.makeGetEvents, function(n) {
                return n.events.eventType = r, (0, e.Ok)(n)
            }, function(r) {
                return r.events.start = n, (0, e.Ok)(r)
            }, function(r) {
                return r.events.end = t, (0, e.Ok)(r)
            }])
        }

        function l(r) {
            return void 0 === r && (r = !1), (0, e.pipe)([e.makeGetLatestBlock, function(n) {
                return n.latestBlock.isSealed = r, (0, e.Ok)(n)
            }])
        }

        function d(r) {
            return (0, e.pipe)([e.makeGetTransactionStatus, function(n) {
                return n.transactionId = r, (0, e.Ok)(n)
            }])
        }

        function m(r) {
            return (0, e.pipe)([function(n) {
                return n.message.computeLimit = r, (0, e.Ok)(n)
            }])
        }

        function v(r) {
            return void 0 === r && (r = []), (0, e.pipe)(r.map(function(r) {
                return (0, e.makeParam)("function" == typeof r ? {
                    resolve: r
                } : r)
            }))
        }
        ...
        var y = {
            ...
            asInjection: function(e) {
                return e
            }
        };

        function g(e, r, n) {
            return void 0 === r && (r = y), void 0 === n && (n = null), {
                key: n,
                value: e,
                xform: r
            }
        ...
        var h = function(r) {
                try {
                    return k(r) ? Promise.resolve((0, e.makeProposer)({
                        resolve: r,
                        role: {
                            proposer: !0
                        }
                    })) : Promise.resolve((0, e.makeProposer)(a({}, r, {
                        role: {
                            proposer: !0
                        }
                    })))
        ...
        function b(r) {
            return (0, e.makePayer)(a({}, "function" == typeof r ? {
                resolve: r
            } : r, {
                role: {
                    payer: !0
        ...
        function I(r) {
            return (0, e.pipe)([function(n) {
                return n.message.refBlock = r, (0, e.Ok)(n)
            }])
        }

        function x() {
            return (0, e.pipe)([e.makeScript, (0, e.put)("ix.cadence", t.templar.apply(void 0, arguments))])
        }
        exports.proposer = h;
        var O = [];

        function j() {
            return (0, e.pipe)([e.makeTransaction, (0, e.put)("ix.cadence", t.templar.apply(void 0, arguments)), function(r) {
                return r.message.computeLimit = r.message.computeLimit || 10, r.message.refBlock = r.message.refBlock || null, r.authorizations = r.authorizations || O, (0, e.Ok)(r)
            }])
        }
        const w = function() {
            function e() {}
            return e.prototype.then = function(r, n) {
                ...
                return this.o = function(e) {
                    try {
                        const o = e.v;
                        1 & e.s ? z(t, 1, r ? r(o) : o) : n ? z(t, 1, n(o)) : z(t, 2, o)
                    } catch (e) {
                        z(t, 2, e)
                    }
                }, t
        ...
        function z(e, r, n) {
            if (!e.s) {
                if (n instanceof w) {
                    if (!n.s) return void(n.o = z.bind(null, e, r));
                    1 & r && (r = n.s), n = n.v
                }
                if (n && n.then) return void n.then(z.bind(null, e, r), z.bind(null, e, 2));
                e.s = r, e.v = n;
                const t = e.o;
                t && t(e)
            }
        ...
        function S(e) {
            return e instanceof w && 1 & e.s
        }
        const q = "undefined" != typeof Symbol ? Symbol.iterator || (Symbol.iterator = Symbol("Symbol.iterator")) : "@@iterator";
        ...
        var B = function(e) {
            ...
            F = function(e) {
                return !(e.role.proposer && !(T(e.addr) && N(e.keyId) && N(e.sequenceNum) && B(e.signingFunction)) || e.role.payer && !(T(e.addr) && N(e.keyId) && B(e.signingFunction)) || e.role.authorizer && !(T(e.addr) && N(e.keyId) && B(e.signingFunction)))
            },
            L = function(e) {
                return void 0 === e && (e = []), e.filter(Boolean)[0] || null
            },
            E = function(e) {
            ...
            G = (0, e.pipe)([function(r) {
                try {
                    var n = function() {
                        return (0, e.Ok)(r)
                    };
                    if (!(0, e.isTransaction)(r)) return Promise.resolve((0, e.Ok)(r));
                    var t = function(e, r, n) {
                        if ("function" == typeof e[q]) {
                            var t, o, i, u = e[q]();
                            if (function e(n) {
                                    try {
                                        for (; !(t = u.next()).done;)
                                            if ((n = r(t.value)) && n.then) {
                                                if (!S(n)) return void n.then(e, i || (i = z.bind(null, o = new w, 2)));
                                                n = n.v
                                            } o ? z(o, 1, n) : o = n
                                    } catch (e) {
                                        z(o || (o = new w), 2, e)
                        ...
                        return function(e, r, n) {
                            ...
                            return function n(u) {
                                try {
                                    for (; ++i < e.length;)
                                        if ((u = r(i)) && u.then) {
                                            if (!S(u)) return void u.then(n, o || (o = z.bind(null, t = new w, 2)));
                                            u = u.v
                                        } t ? z(t, 1, u) : t = u
                                } catch (e) {
                                    z(t || (t = new w), 2, e)
                    ...
                    }(Object.entries(r.accounts), function(e) {
                        var n = e[0],
                            t = e[1];

                        function o() {
                            A(F(r.accounts[n]), "Account unable to fulfill role", r.accounts[n])
                        }
                        var i = function() {
                            if (B(t.resolve)) return Promise.resolve(t.resolve(t)).then(function(e) {
                                r.accounts[n] = e
                            })
                        }();
                ...
                try {
                    ...
                    for (var n = function() {
                            var e, n, i, u = o[t],
                                s = u.addr + "|" + u.keyId;
                            r.accounts[s] = null != r.accounts[s] ? (e = r.accounts[s], n = a({
                                tempId: s
                            }, u), {
                                kind: L([e.kind, n.kind]),
                                tempId: L([e.tempId, n.tempId]),
                                addr: L([e.addr, n.addr]),
                                keyId: (i = [e.keyId, n.keyId], void 0 === i && (i = []), "number" == typeof i.filter(N)[0] ? i.filter(N)[0] : null),
                                sequenceNum: "number" == typeof E([e, n]).sequenceNum ? E([e, n]).sequenceNum : e.sequenceNum,
                                signature: L([e.signature, n.signature]),
                                signingFunction: L([e.signingFunction, n.signingFunction]),
                                resolve: L([e.resolve, n.resolve]),
                                role: {
                                    proposer: e.role.proposer || n.role.proposer,
                                    authorizer: e.role.authorizer || n.role.authorizer,
                                    payer: e.role.payer || n.role.payer,
                                    param: e.role.param || n.role.param
                                }
                            }) : a({
                                tempId: s
                            }, u), r.proposer === u.tempId && (r.proposer = s), r.payer === u.tempId && (r.payer = s), r.authorizations = r.authorizations.map(function(e) {
                                return e === u.tempId ? s : e
                            }), delete r.accounts[u.tempId]
                        }, t = 0, o = Object.values(r.accounts); t < o.length; t++) n();
                    for (var i = 0, u = Object.values(r.accounts); i < u.length; i++) {
                        var s = u[i];
                        A(F(s), "Account unable to fulfill roles", s)
                    }
                    return Promise.resolve((0, e.Ok)(r))
                } catch (r) {
                    return Promise.reject(r)
                }
            }]),
            R = function(r) {
                try {
                    var n = function(e) {
                        ...
                        t = !1;
                    if (!(0, e.isTransaction)(r) && !(0, e.isScript)(r)) return Promise.resolve((0, e.Ok)(r));
                    var o = (0, e.get)(r, "ix.cadence");
                    if ("string" == typeof o) return r.message.cadence = o, Promise.resolve((0, e.Ok)(r));
                    var i = function() {
                        if ("function" == typeof o) {
                            var n = Object.values(r.params);
                            return Promise.resolve(Promise.all(n.map(function(e) {
                                try {
                                    var r = !1,
                                        n = function() {
                                            if ("function" == typeof e.resolve) return r = !0, Promise.resolve(e.resolve()).then(function(r) {
                                                return a({}, r, {
                                                    tempId: e.tempId
                                                })
                                            })
                                ...
                                return n.forEach(function(e) {
                                    r.params[e.tempId] = e
                                }), n = Object.fromEntries(n.filter(function(e) {
                                    return null != e.key
                                }).map(function(e) {
                                    return [e.key, e.xform.asInjection(e.value)]
                                })), r.message.cadence = o(n), t = !0, (0, e.Ok)(r)
                            })
                        }
                    }();
            ...
            K = function(r) {
                try {
                    if (!(0, e.isTransaction)(r)) return Promise.resolve((0, e.Ok)(r));
                    var n = r.authorizations.map(function(e) {
                            return r.accounts[e]
                        }),
                        t = r.accounts[r.payer],
                        i = r.accounts[r.proposer],
                        u = (0, o.encodeTransactionPayload)({
                            ...
                            payer: t.addr,
                            authorizers: n.map(function(e) {
                                return e.addr
                            })
                        }),
                        s = n.map(function(e) {
                            try {
                                return e.addr === t.addr ? (r.accounts[e.tempId] = a({}, r.accounts[e.tempId], {
                                    signature: null
                                }), Promise.resolve()) : Promise.resolve(e.signingFunction({
                                    message: u,
                                    addr: e.addr,
                                    keyId: e.keyId,
                                    roles: {
                                        proposer: i.addr === e.addr,
                                        authorizer: !0,
                                        payer: t.addr === e.addr
                                    },
                                    interaction: r
                                })).then(function(n) {
                                    r.accounts[e.tempId] = a({}, r.accounts[e.tempId], {
                    ...
                    return Promise.resolve(Promise.all(s)).then(function() {
                        n = r.authorizations.map(function(e) {
                            return r.accounts[e]
                        });
                        var u = (0, o.encodeTransactionEnvelope)({
                            script: r.message.cadence,
                            refBlock: r.message.refBlock || null,
                            gasLimit: r.message.computeLimit,
                            proposalKey: {
                        ...
                        return Promise.resolve(t.signingFunction({
                            message: u,
                            addr: t.addr,
                            keyId: t.keyId,
                            roles: {
                                proposer: i.addr === t.addr,
                                authorizer: Boolean(n.find(function(e) {
                                    return e.addr === t.addr
                                })),
                                payer: !0
                            },
                            interaction: r
                        })).then(function(n) {
                            return r.accounts[r.payer] = a({}, r.accounts[r.payer], {
                                signature: n.signature
                            }), (0, e.Ok)(r)
                        })
                    })
        ...
        exports.resolveSignatures = K, exports.resolveParams = R, exports.resolveAccounts = G;
    }, {
        "@onflow/interaction": "FaBc",
        "@onflow/send": "HjM1",
        "@onflow/decode": "HpQW",
    ...
    "pcN9": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
    ...
    "HKMW": [function(require, module, exports) {
        var global = arguments[3];
        var e, t = arguments[3],
            r = (e = require("queue-microtask")) && "object" == typeof e && "default" in e ? e.default : e,
            n = require("@onflow/sdk"),
            o = require("@onflow/types");
        const i = function() {
            function e() {}
            return e.prototype.then = function(t, r) {
                ...
                return this.o = function(e) {
                    try {
                        const o = e.v;
                        1 & e.s ? u(n, 1, t ? t(o) : o) : r ? u(n, 1, r(o)) : u(n, 2, o)
                    } catch (e) {
                        u(n, 2, e)
                    }
                }, n
        ...
        function u(e, t, r) {
            if (!e.s) {
                if (r instanceof i) {
                    if (!r.s) return void(r.o = u.bind(null, e, t));
                    1 & t && (t = r.s), r = r.v
                }
                if (r && r.then) return void r.then(u.bind(null, e, t), u.bind(null, e, 2));
                e.s = t, e.v = r;
                const n = e.o;
                n && n(e)
            }
        ...
        function s(e, t, r) {
            ...
            var l = new i,
                f = u.bind(null, l, 2);
            return (0 === n ? o.then(m) : 1 === n ? s.then(d) : a.then(h)).then(void 0, f), l;

            function d(n) {
                s = n;
                do {
                    if (t && (a = t()) && a.then && !c(a)) return void a.then(h).then(void 0, f);
                    if (!(o = e()) || c(o) && !o.v) return void u(l, 1, s);
                    if (o.then) return void o.then(m).then(void 0, f);
                    c(s = r()) && (s = s.v)
                } while (!s || !s.then);
                s.then(d).then(void 0, f)
            }

            function m(e) {
                e ? (s = r()) && s.then ? s.then(d).then(void 0, f) : d(s) : u(l, 1, s)
            }

            function h() {
                (o = e()) ? o.then ? o.then(m).then(void 0, f) : m(o): u(l, 1, s)
            }
        }
        ...
        var f = "object" == typeof self && self.self === self && self || "object" == typeof t && t.global === t && t || "object" == typeof window && window.window === window && window;
        f.FCL_REGISTRY = null == f.FCL_REGISTRY ? {} : f.FCL_REGISTRY;
        var d, m = 0,
            h = function(e, t, r, n) {
                return void 0 === n && (n = {}), new Promise(function(o, i) {
                    var u = n.expectReply || !1,
                        c = null != n.timeout ? n.timeout : 5e3;
                    ...
                    try {
                        f.FCL_REGISTRY[e].mailbox.deliver(s), u || o(!0)
                    } catch (e) {
                        console.error("FCL.Actor -- Could Not Deliver Message", s, e)
                    }
                })
            },
            v = function(e, t) {
                if (void 0 === t && (t = null), null == t && (t = ++m), null != f.FCL_REGISTRY[t]) return t;
                var n, o;
                f.FCL_REGISTRY[t] = {
                    addr: t,
                    mailbox: (o = [], {
                        deliver: function(e) {
                            try {
                                return o.push(e), n && (n(o.shift()), n = void 0), Promise.resolve()
                            } catch (e) {
                                return Promise.reject(e)
                            }
                        },
                ...
                var i, u = {
                    ...
                    receive: function() {
                        return f.FCL_REGISTRY[t].mailbox.receive()
                    },
                    send: function(e, r, n, o) {
                        return void 0 === o && (o = {}), o.from = t, h(e, r, n, o)
                    },
                    broadcast: function(e, r, n) {
                        void 0 === n && (n = {}), n.from = t;
                        for (var o, i = function(e) {
                                ...
                                if ("undefined" == typeof Symbol || null == e[Symbol.iterator]) {
                                    if (Array.isArray(e) || (e = function(e, t) {
                                            if (e) {
                                                ...
                                                return "Object" === r && e.constructor && (r = e.constructor.name), "Map" === r || "Set" === r ? Array.from(r) : "Arguments" === r || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r) ? l(e, void 0) : void 0
                                            }
                                        }(e))) return function() {
                                        return t >= e.length ? {
                                            done: !0
                            ...
                            }(f.FCL_REGISTRY[t].subs); !(o = i()).done;) h(o.value, e, r, n)
                    },
                    subscribe: function(e) {
                        return null != e && f.FCL_REGISTRY[t].subs.add(e)
                    },
                    unsubscribe: function(e) {
                        return null != e && f.FCL_REGISTRY[t].subs.delete(e)
                    },
                    put: function(e, r) {
                        null != e && (f.FCL_REGISTRY[t].kvs[e] = r)
                    },
                    get: function(e, r) {
                        var n = f.FCL_REGISTRY[t].kvs[e];
                        return null == n ? r : n
                    },
                    delete: function(e) {
                        delete f.FCL_REGISTRY[t].kvs[e]
                    },
                    update: function(e, r) {
                        null != e && (f.FCL_REGISTRY[t].kvs[e] = r(f.FCL_REGISTRY[t].kvs[e]))
                    },
                    keys: function() {
                        return Object.keys(f.FCL_REGISTRY[t].kvs)
                    },
                    all: function() {
                        return f.FCL_REGISTRY[t].kvs
                    },
                    where: function(e) {
                        return Object.keys(f.FCL_REGISTRY[t].kvs).reduce(function(r, n) {
                            var o;
                            return e.test(n) ? a({}, r, ((o = {})[n] = f.FCL_REGISTRY[t].kvs[n], o)) : r
                        }, {})
                    },
                    merge: function(e) {
                        void 0 === e && (e = {}), Object.keys(e).forEach(function(r) {
                            return f.FCL_REGISTRY[t].kvs[r] = e[r]
                        })
                    }
                };
                return "object" == typeof e && (void 0 === (i = e) && (i = {}), e = function(e) {
                    try {
                        var t = function() {
                                var t = s(function() {
                                    return 1
                                }, void 0, function() {
                                    return Promise.resolve(e.receive()).then(function(t) {
                                        var r = function(r, n) {
                                            try {
                                                var o = function(r, n) {
                                                    try {
                                                        var o = function() {
                                                            function r() {
                                                                return Promise.resolve(i[t.tag](e, t, t.data || {})).then(function() {})
                                                            }
                                                            var n = function() {
                                                                if ("EXIT" === t.tag) {
                                                                    var r = function() {
                                                                        if ("function" == typeof i.TERMINATE) return Promise.resolve(i.TERMINATE(e, t, t.data || {})).then(function() {})
                                                                    }();
                                                    ...
                                                    console.error(e.self() + " Error", t, r)
                                                })
                                            } catch (e) {
                                                return
                                            }
                                            return o && o.then ? o.then(n.bind(null, !1), n.bind(null, !0)) : void 0
                                        }(0, function(e, t) {});
                                        if (r && r.then) return r.then(function() {})
                                    })
                                });
                            ...
                            r = function() {
                                if ("function" == typeof i.INIT) return Promise.resolve(i.INIT(e)).then(function() {})
                            }();
                    ...
                    try {
                        return Promise.resolve(e(u)).then(function() {
                            var e;
                            e = t, delete f.FCL_REGISTRY[e]
                        })
                    } catch (e) {
                        return Promise.reject(e)
                    }
            ...
            E = ((d = {})[y] = function(e, t, r) {
                var n = r.key,
                    o = r.value;
                if (null == n) throw new Error("Missing 'key' for config/put.");
                e.put(n, o), e.broadcast(P, e.all())
            }, d[b] = function(e, t, r) {
                var n = r.key,
                    o = r.fallback;
                if (null == n) throw new Error("Missing 'key' for config/get");
                t.reply(e.get(n, o))
            }, d.UPDATE_CONFIG = function(e, t, r) {
                var n = r.key,
                    o = r.fn;
                if (null == n) throw new Error("Missing 'key' for config/update");
                e.update(n, o || g), e.broadcast(P, e.all())
            }, d.DELETE_CONFIG = function(e, t, r) {
                var n = r.key;
                if (null == n) throw new Error("Missing 'key' for config/delete");
                e.delete(n), e.broadcast(P, e.all())
            }, d.WHERE_CONFIG = function(e, t, r) {
                var n = r.pattern;
                if (null == n) throw new Error("Missing 'pattern' for config/where");
                t.reply(e.where(n))
            }, d.SUBSCRIBE = function(e, t) {
                e.subscribe(t.from), e.send(t.from, P, e.all())
            }, d.UNSUBSCRIBE = function(e, t) {
        ...
        function I(e, t) {
            return void 0 === t && (t = g), h(p, "UPDATE_CONFIG", {
                key: e,
                fn: t
            }), O()
        }
        ...
        function T(e) {
            return h(p, "DELETE_CONFIG", {
                key: e
            }), O()
        }

        function j(e) {
            return h(p, "WHERE_CONFIG", {
                pattern: e
            }, {
                expectReply: !0,
                timeout: 10
        ...
        function w(e) {
            var t = v(function(t) {
                try {
                    var r = !1;
                    return t.send(p, "SUBSCRIBE"), Promise.resolve(s(function() {
                        return !r && 1
                    }, void 0, function() {
                        return Promise.resolve(t.receive()).then(function(n) {
                            if ("@EXIT" === n.tag) return t.send(p, "UNSUBSCRIBE"), void(r = !0);
                            e(n.data)
                        })
                    }))
                } catch (e) {
        ...
        v(E, p), O().put("accessNode.api", "http://localhost:8080").put("challenge.handshake", "http://localhost:8700/authenticate");
        var x, C = function(e) {
                try {
                    return Promise.resolve(n.resolve(e, [n.resolveParams, n.resolveAccounts, n.resolveSignatures]))
                } catch (e) {
                    return Promise.reject(e)
                }
            },
            k = function(e, t) {
                ...
                try {
                    var r = function(r) {
                            return t.node = r, Array.isArray(e) && (e = n.build(e)), Promise.resolve(C(e)).then(function(e) {
                                return n.send(e, t)
                            })
                        },
                        o = t.node;
                    return Promise.resolve(o ? r(o) : Promise.resolve(O().get("accessNode.api")).then(r))
                } catch (e) {
                    return Promise.reject(e)
                }
            },
            L = function(e) {
                try {
                    return Promise.resolve(O().where(/^decoder\./)).then(function(t) {
                        var r = Object.fromEntries(Object.entries(t).map(function(e) {
                            var t = e[0],
                                r = e[1];
                            return [t = "/" + t.replace(/^decoder\./, "") + "$/", r]
                        }));
                        return n.decodeResponse(e, r)
                    })
                } catch (e) {
                    return Promise.reject(e)
                }
            ...
            N = function(e) {
                try {
                    return Promise.resolve(k([n.getTransactionStatus(e)])).then(L)
                } catch (e) {
                    return Promise.reject(e)
                }
            },
            ...
            U = ((x = {}).INIT = function(e) {
                try {
                    return Promise.resolve(N(e.self())).then(function(t) {
                        A(t) || setTimeout(function() {
                            return h(e.self(), "POLL")
                        }, 1e3), e.merge(t)
                    })
                } catch (e) {
                    return Promise.reject(e)
                }
            }, x.SUBSCRIBE = function(e, t) {
                e.subscribe(t.from), e.send(t.from, "TRANSACTION/UPDATED", e.all())
            }, x.UNSUBSCRIBE = function(e, t) {
                e.unsubscribe(t.from)
            }, x.SNAPSHOT = function(e, t) {
                try {
                    return t.replay(e.all()), Promise.resolve()
                } catch (e) {
                    return Promise.reject(e)
                }
            }, x.POLL = function(e) {
                try {
                    return Promise.resolve(N(e.self())).then(function(t) {
                        A(t) || setTimeout(function() {
                            return h(e.self(), "POLL")
                        }, 1e3), e.merge(t), e.broadcast("TRANSACTION/UPDATED", e.all())
                    })
                } catch (e) {
                    return Promise.reject(e)
                }
            ...
            function t(t) {
                var r = _(e),
                    n = v(function(e) {
                        try {
                            var n = !1;
                            return e.send(r, "SUBSCRIBE"), Promise.resolve(s(function() {
                                return !n && 1
                            }, void 0, function() {
                                return Promise.resolve(e.receive()).then(function(o) {
                                    if ("@EXIT" === o.tag) return e.send(r, "UNSUBSCRIBE"), void(n = !0);
                                    t(o.data)
                                })
                            }))
                        } catch (e) {
        ...
        var G, B = "FCL_IFRAME_CHALLENGE",
            ...
            M = function(e, t) {
                try {
                    for (var r = new URL(e.endpoint), n = 0, o = Object.entries(e.params || {}); n < o.length; n++) {
                        var i = o[n];
                        r.searchParams.append(i[0], i[1])
                    }
                    return t = t ? JSON.stringify(t) : void 0, Promise.resolve(fetch(r, {
                        method: H[e.method],
                        headers: {
            ...
            z = function() {
                try {
                    return Q(), Promise.resolve(ne()).then(function(e) {
                        var t = e.addr;
                        if (null == t) throw new Error("No Flow Address for Current User");
                        return Promise.resolve(k([n.getAccount(t)])).then(function(e) {
                            return e.account
                        })
                    })
                } catch (e) {
            ...
            X = function(e) {
                try {
                    return Q(), Promise.resolve(q()).then(function() {
                        return Promise.resolve(ne()).then(function(t) {
                            function r() {
                                return a({}, e, {
                                    addr: t.addr,
                                    keyId: t.keyId,
                                    ...
                                    signingFunction: function(e) {
                                        try {
                                            return Promise.resolve(ne()).then(function(t) {
                                                return Promise.resolve(z()).then(function(r) {
                                                    return Promise.resolve(M(t.authorizations[0], e)).then(function(e) {
                                                        var t = function() {};
                                                        return e.local && e.local.length > 0 && (console.log("RENDER LOCAL"), t = function(e) {
                                                            if (!document.getElementById(Y)) {
                                                                for (var t = new URL(e.endpoint), r = 0, n = Object.entries(e.params || {}); r < n.length; r++) {
                                                                    var o = n[r];
                                                                    t.searchParams.append(o[0], o[1])
                                                                }
                                                                var i = document.createElement("iframe");
                                                                return i.src = t.href, i.id = Y, i.style.height = e.height || "500px", i.style.maxHeight = "90vh", i.style.width = e.width || "400px", i.style.maxWidth = "90vw", i.style.display = "block", i.style.background = e.background || "#fff", i.style.position = "fixed", i.style.top = "5vh", i.style.right = "calc(50vw)", i.style.transform = "translateX(50%)", i.style.boxShadow = "0 4px 8px -4px black", i.frameBorder = "0", document.body.append(i),
                                                                    function() {
                                                                        document.getElementById(Y) && document.getElementById(Y).remove()
                                                                    }
                                                            }
                                                        }(e.local[0])), Promise.resolve(function e(t) {
                                                            return new Promise(function(r, n) {
                                                                try {
                                                                    return Promise.resolve(M(t)).then(function(t) {
                                                                        "APPROVED" === t.status ? r(t.compositeSignature) : "DECLINED" === t.status ? n({
                                                                            status: t.status,
                                                                            reason: t.reason
                                                                        }) : setTimeout(function() {
                                                                            r(e(t.authorizationUpdates))
                                                                        }, 500)
                                                                    })
                                                                } catch (e) {
                                                                    return Promise.reject(e)
                                                        ...
                                                        }(e.authorizationUpdates)).then(function(e) {
                                                            return t(), e
                                                        })
                                                    })
                                                })
                            ...
                            var n, o = function() {
                                if (e.role.proposer) return Promise.resolve(z()).then(function(e) {
                                    var r = e.keys.find(function(e) {
                                        return e.index === t.keyId
                                    });
                                    n = r.sequenceNumber
                                })
                            }();
            ...
            q = function() {
                try {
                    return Promise.resolve(new Promise(function(e) {
                        try {
                            return Q(), Promise.resolve(ne()).then(function(t) {
                                return t.loggedIn ? e(t) : Promise.resolve(O().get("challenge.handshake")).then(function(t) {
                                    return Promise.resolve(O().get("challenge.scope")).then(function(r) {
                                        var n = function(e) {
                                            var t = e.handshake,
                                                r = e.scope,
                                                n = e.nonce,
                                            ...
                                            if (!document.getElementById(B)) {
                                                var i = new URL(t);
                                                i.searchParams.append("l6n", o), i.searchParams.append("nonce", n), r && i.searchParams.append("scope", r.split(" ").join("+"));
                                                var u = document.createElement("iframe");
                                                return u.src = i.href, u.id = B, u.style.height = "500px", u.style.maxHeight = "90vh", u.style.width = "400px", u.style.maxWidth = "90vw", u.style.display = "block", u.style.background = "#fff", u.style.position = "fixed", u.style.top = "5vh", u.style.right = "calc(50vw)", u.style.transform = "translateX(50%)", u.style.boxShadow = "0 4px 8px -4px black", u.frameBorder = "0", document.body.append(u),
                                                    function() {
                                                        document.getElementById(B) && document.getElementById(B).remove()
                                                    }
                                            }
                                        }({
                                            handshake: t,
                                        ...
                                        window.addEventListener("message", function(t) {
                                            var r = t.data;
                                            try {
                                                if (r.type !== V) return Promise.resolve();
                                                n();
                                                var o = new URL(r.hks);
                                                return o.searchParams.append("code", r.code), Promise.resolve(fetch(o, {
                                                    method: "GET",
                                                    headers: {
                                                        "Content-Type": "application/json"
                                                    }
                                                    ...
                                                    return h(J, $, a({}, t, {
                                                        ...
                                                        loggedIn: !0,
                                                        verified: !0
                                                    })), Promise.resolve(ne()).then(function(t) {
                                                        e(t)
                                                    })
                                                })
                                            } catch (e) {
            ...
            J = "CURRENT_USER",
            W = "CURRENT_USER/UPDATED",
            $ = "SET_CURRENT_USER",
            V = "FCL::CHALLENGE::RESPONSE",
            Z = '{\n  "cid":null,\n  "loggedIn":null,\n  "verified":null,\n  "identity":{\n    "name":null,\n    "addr":null,\n    "avatar":null,\n    "cover":null,\n    "color":null,\n    "bio":null\n  },\n  "scoped":{},\n  "provider":{\n    "addr":null,\n    "pid":null,\n    "name":null,\n    "icon":null\n  },\n  "authorizations":[]\n}',
            K = ((G = {}).INIT = function(e) {
                e.merge(JSON.parse(Z))
            }, G.SUBSCRIBE = function(e, t) {
                e.subscribe(t.from), e.send(t.from, W, e.all())
            }, G.UNSUBSCRIBE = function(e, t) {
                e.unsubscribe(t.from)
            }, G.SNAPSHOT = function(e, t) {
                try {
                ...
                try {
                    return e.merge(r), e.broadcast(W, e.all()), Promise.resolve()
                } catch (e) {
                    return Promise.reject(e)
                }
            }, G.DEL_CURRENT_USER = function(e, t) {
                try {
                    return e.merge(JSON.parse(Z)), e.broadcast(W, e.all()), Promise.resolve()
                } catch (e) {
                    return Promise.reject(e)
                }
            }, G.GET_AS_PARAM = function(e, t, r) {
                var n = r.key;
                try {
                    return t.reply({
                        key: n,
                        value: e.get("addr", null),
                        xform: o.Identity
                    }), Promise.resolve()
                } catch (e) {
                    return Promise.reject(e)
        ...
        function re(e) {
            ...
            var t = v(function(t) {
                try {
                    var r = !1;
                    return t.send(J, "SUBSCRIBE"), Promise.resolve(s(function() {
                        return !r && 1
                    }, void 0, function() {
                        return Promise.resolve(t.receive()).then(function(n) {
                            if ("@EXIT" === n.tag) return t.send(J, "UNSUBSCRIBE"), void(r = !0);
                            e(n.data)
                        })
                    }))
                } catch (e) {
        ...
        Object.defineProperty(exports, "authorization", {
            ...
            return oe().authenticate()
        }, exports.config = O, exports.currentUser = oe, exports.decode = L, exports.resolve = C, exports.send = k, exports.serialize = function(e) {
            void 0 === e && (e = []);
            try {
                var t = function() {
                        return Promise.resolve(C(e)).then(JSON.stringify)
                    },
                    r = function() {
                        if (Array.isArray(e)) return Promise.resolve(n.build(e)).then(function(t) {
                            e = t
                        })
                    }();
                return Promise.resolve(r && r.then ? r.then(t) : t())
        ...
        }, exports.tx = F, exports.unauthenticate = function() {
            return oe().unauthenticate()
        };
    }, {
        "queue-microtask": "A2wr",
        "@onflow/sdk": "hwMU",
        "@onflow/types": "pcN9"
    }]
}, {}, ["HKMW"], null)
...
const x = (() => {
	...
	return parcelRequire.call(globalThis, "HKMW", module, exports);
})();
export default x;