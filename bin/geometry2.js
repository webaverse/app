...
var PThread = {
 ...
 freeThreadData: function(pthread) {
  ...
  if (pthread.threadInfoStruct) {
   var tlsMemory = SAFE_HEAP_LOAD(pthread.threadInfoStruct + 104 | 0, 4, 0) | 0;
   SAFE_HEAP_STORE(pthread.threadInfoStruct + 104 | 0, 0 | 0, 4);
   _free(tlsMemory);
...
var _pushRequest = Module["_pushRequest"] = createExportWrapper("pushRequest");

var _popResponse = Module["_popResponse"] = createExportWrapper("popResponse");
