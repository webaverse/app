...
import {maxGrabDistance, throwReleaseTime, storageHost, minFov, maxFov, throwAnimationDuration, walkSpeed, crouchSpeed, flySpeed} from './constants.js';
...
import gameSettingsManager from './gamesettings-manager.js';
...
class GameManager extends EventTarget {
  ...
  menuDoubleTap() {
    const gameSettings = gameSettingsManager.getGameSettings();
    if (gameSettings.allowNarutoRun && !this.isCrouched()) {
      const localPlayer = playersManager.getLocalPlayer();
