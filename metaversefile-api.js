...
import {getRenderer, scene, sceneHighPriority, sceneLowPriority, rootScene, postSceneOrthographic, postScenePerspective, camera} from './src/renderer.js';
import physicsManager from './src/managers/physics-manager.js';
import Avatar from './avatars/avatars.js';
import {world} from './src/world.js';
// import * as ui from './vr-ui.js';
import {ShadertoyLoader} from './src/three/shadertoy.js';
import {GIFLoader} from './src/utils/GIFLoader.js';
import {VOXLoader} from './src/three/VOXLoader.js';
import ERC721 from './src/utils/erc721-abi.json';
import ERC1155 from './src/utils/erc1155-abi.json';
import {web3} from './src/utils/blockchain.js';
import {moduleUrls, modules} from './metaverse-modules.js';
import {componentTemplates} from './metaverse-components.js';
import {LocalPlayer, /*RemotePlayer,*/ NpcPlayer} from './src/character-controller.js';
import * as postProcessing from './src/three/post/post-processing.js';
// import {getState} from './state.js';
import {makeId, getRandomString, getPlayerPrefix} from './src/utils/util.js';
import JSON6 from 'json-6';
import {initialPosY} from './src/utils/constants.js';
import * as materials from './src/three/materials.js';
import * as geometries from './src/three/geometries.js';
import soundManager from './src/managers/sound-manager.js';
import {isSceneLoaded, waitForSceneLoaded} from './src/universe.js';
