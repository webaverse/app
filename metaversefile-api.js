...
const npcs = [];
const pathFinder = new PathFinder({ width: 71, height: 71, voxelHeight: 2, lowestY: 0.1, debugRender: true }); // for treehouse.scn
// const pathFinder = new PathFinder({ width: 71, height: 71, voxelHeight: 2, lowestY: -50, debugRender: true }); // for marching-cube.scn
