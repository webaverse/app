...
export default function Chains() {
  ...
  return (<div className={styles.chainSelector}>
    <div style={{background: brandColor || 'black'}} className={styles.selectedChain} onClick={() => setOpen(!open)}><img src={open ? '/images/ui/chainUp.svg' : '/images/ui/chainDown.svg'} /><Supported chain={selectedChain} /> {selectedChain.name}</div>
