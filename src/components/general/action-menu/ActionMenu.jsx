...
export const ActionMenu = ({setUIMode, className}) => {
  ...
  return (
    <div
      className={classnames(className, styles.actionMenu)}
    ...
    >
      <div className={styles.btnWrapper}>
        <div
          className={classnames(
            styles.btn,
            state.openedPanel === 'WorldPanel' ? styles.wpOpened : null,
          )}
      ...
      <div className={styles.btnWrapper}>
        <div
          className={classnames(styles.btn, styles.settings)}
      ...
      <div className={styles.btnWrapper}>
        <div
          className={classnames(styles.btn, styles.mode)}
      ...
      <div className={styles.btnWrapper}>
        <div
          className={classnames(
            styles.btn,
            styles.vr,
            xrSupported ? null : styles.disabled,
          )}
          onClick={handleVRBtnClick}
        >
          <img
            src="images/webpencil.svg"
            className={classnames(styles.background, styles.blue)}
          ...
          <span className={styles.text}>
            {xrSupported ? '仮想現実 VR ' : '仮想現実 VR (no)'}
          </span>
        </div>
      </div>
    </div>
