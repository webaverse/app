...
import styles from './light-arrow.module.css';
...
export const LightArrow = function({ enabled = true, animate = false, x, y }) {
    ...
    return (
        ...
        >
            <div className={ classnames( styles.lightArrow, animate ? styles.animate : null )} >
