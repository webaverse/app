...
export const CharacterSelect = () => {
  ...
  const _updateArrowPosition = (e) => {
    if (targetCharacter && menuRef) {
      ...
      if (el) {
        ...
        setArrowPosition([
          Math.floor(e.clientX - parentRect.left - 20),
          Math.floor(e.clientY - parentRect.top - 20),
        ]);
      } else {
            ...
            <div className={styles.subheading}>
              ...
              <div className={styles.cryptoavatars}>
                ...
                <div className={styles.inputGroup}>
                  <h3>Pages:</h3>
                  {caPagination.prev && (
                    <button value="prev" onClick={caNavigation}>
                      {"<"}
                    </button>
                  )}
                  <h4>
                  ...
                  {caPagination.next && (
                    <button value="next" onClick={caNavigation}>
                      {">"}
                    </button>
                  )}
                </div>
