...
import styles from './object-preview.module.css';
...
export const ObjectPreview = ({ object = null, className = null }) => {
    ...
    return (
        <canvas className={ classnames( className, styles.objectPreview ) } width={ canvasWidth } height={ canvasHeight } ref={ canvasRef } />
    );
