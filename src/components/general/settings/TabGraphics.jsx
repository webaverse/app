...
export const TabGraphics = ({active}) => {
  ...
  function loadSettings() {
    ...
    setPostprocessing(
      settings.postprocessing.enabled ?? DefaultSettings.postprocessing.enabled,
    );
    setDepthOfField(
      settings.postprocessing.depthOfField ??
        DefaultSettings.postprocessing.depthOfField,
    );
    setHdr(settings.postprocessing.hdr ?? DefaultSettings.postprocessing.hdr);
    setBloom(
      settings.postprocessing.bloom ?? DefaultSettings.postprocessing.bloom,
    );
    setCharacterDetails(
      settings.character.details ?? DefaultSettings.character.details,
    );
    setHairPhysics(
      settings.character.hairPhysics ?? DefaultSettings.character.hairPhysics,
    );
  }
    ...
    >
      ...
      <div className={styles.row}>
        ...
        <Switch
          className={styles.switch}
          value={antialias}
          setValue={setAntialias}
          values={['MSAA', 'FXAA', 'NONE']}
        />
        <div className={styles.clearfix} />
      </div>
      <div className={styles.row}>
