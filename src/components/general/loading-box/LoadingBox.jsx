...
export const LoadingBox = () => {
    ...
    return (
        <div className={ classnames( styles.loadingBox, open ? styles.open : null ) } >
            <canvas className={ styles.canvas } width={ size } height={ size } ref={ canvasRef } />
            <div className={ styles.wrap } >
                <div className={ styles.name } >{ name }</div>
                <div className={ styles.detail } >{ detail }</div>
                <progress className={ styles.progress } value={ progress.progress } max={ progress.total } />
            </div>
        </div>
    );
