...
// import { terrainVertex, terrainFragment } from '@engine/rendering/shaders/terrainShader.js';
// import physics from '@engine/physics/physics-manager.js';
    ...
    if (!this.loadPromise) {
      this.loadPromise = (async () => {
        ...
        for (let i = 0; i < this.numWorkers; i++) {
          const worker = new Worker('./engine/physics/physx-worker.js?import', {
            type: 'module',
          });
          const cbs = new Map();
          worker.onmessage = e => {
