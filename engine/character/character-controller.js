...
import {getRenderer, scene, camera, dolly} from '@engine/rendering/renderer.js';
...
import {CharacterHitter} from '@engine/character/character-hitter.js';
import {CharacterBehavior} from './character-behavior.js';
import {CharacterFx} from './character-fx.js';
import {VoicePack, VoicePackVoicer} from '@engine/audio/voice-pack-voicer.js';
import {VoiceEndpoint, VoiceEndpointVoicer} from '@engine/audio/voice-endpoint-voicer.js';
...
import {applyPlayerToAvatar, switchAvatar} from '@engine/avatars/player-avatar-binding.js';
import {
  defaultPlayerName,
  defaultPlayerBio,
} from '@engine/ai/lore-model.js';
// import * as sounds from '@engine/audio/sounds.js';
import musicManager from '@engine/audio/music-manager.js';
import {makeId, clone, unFrustumCull, enableShadows} from '@engine/utils/util.js';
import overrides from '@engine/overrides.js';
