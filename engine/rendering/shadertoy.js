...
import {scene, camera, getRenderer} from '@engine/rendering/renderer.js';
import {copyScenePlaneGeometry, copySceneVertexShader, copyScene, copySceneCamera} from '@engine/rendering/shaders.js';
...
(async () => {
  const res = await fetch('@engine/rendering/shaders.json');
