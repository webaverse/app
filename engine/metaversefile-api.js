...
import {getRenderer, scene, sceneHighPriority, sceneLowPriority, sceneLowerPriority, sceneLowestPriority, rootScene, camera} from '@engine/rendering/renderer.js';
...
import ERC721 from '@engine/blockchain/erc721-abi.json';
import ERC1155 from '@engine/blockchain/erc1155-abi.json';
import {web3} from '@engine/blockchain/blockchain.js';
import {moduleUrls, modules} from '@metaverse-modules/index.js';
import {componentTemplates} from '@engine/components/index.js';
import postProcessing from '@engine/rendering/post-processing.js';
import {getRandomString, memoize} from '@engine/utils/util.js';
import * as mathUtils from '@engine/utils/math-utils.js';
import JSON6 from 'json-6';
import * as geometries from '@engine/geometry/geometries.js';
import * as materials from '@engine/rendering/materials.js';
import meshLodManager from '@engine/geometry/mesh-lodder.js';
import * as avatarCruncher from '@engine/optimization/avatar-cruncher.js';
import * as avatarSpriter from '@engine/rendering/avatar-spriter.js';
import {chatManager} from '@engine/ui/chat-manager.js';
import loreAI from '@engine/ai/lore-ai.js';
import npcManager from '@engine/ai/npc-manager.js';
import mobManager from '@engine/mob-manager.js';
...
import renderSettingsManager from '@engine/rendering/rendersettings-manager.js';
import questManager from '@engine/ai/quest-manager.js';
import {murmurhash3} from '@engine/procgen/murmurhash3.js';
import debug from '@engine/utils/debug.js';
import * as sceneCruncher from '@engine/optimization/scene-cruncher.js';
import * as scenePreviewer from '@engine/rendering/scene-previewer.js';
import * as sounds from '@engine/audio/sounds.js';
import * as lodder from '@engine/geometry/lod.js';
import hpManager from '@engine/hp-manager.js';
import particleSystemManager from '@engine/particle-system.js';
import domRenderEngine from '@engine/ui/dom-renderer.jsx';
import dropManager from '@engine/drop-manager.js';
import hitManager from '@engine/character/character-hitter.js';
// import dcWorkerManager from './dc-worker-manager.js';
import procGenManager from '@engine/procgen/procgen-manager.js';
import cardsManager from '@engine/ui/cards-manager.js';
import * as instancing from '@engine/geometry/instancing.js';
import * as atlasing from '@engine/optimization/atlasing.js';
