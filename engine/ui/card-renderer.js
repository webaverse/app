...
import {generateStats, types} from '@engine/procgen/procgen.js';
import {screenshotObjectApp} from '@engine/rendering/object-screenshotter.js';
import {screenshotAvatarUrl} from '@engine/rendering/avatar-screenshotter.js';
import {generateGlyph} from '@engine/utils/glyph-generator.js';
import {splitLinesToWidth} from '@engine/utils/util.js';

const cardsSvgUrl = `@public/images/cards-01.svg`;
...
export const generateObjectCard = async ({
  ...
  let minterAvatarPreview = await screenshotAvatarUrl({
    start_url: `@engine/avatars/scillia_drophunter_v15_vian.vrm`,
  });
