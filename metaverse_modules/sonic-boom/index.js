...
const {useApp, useFrame, useCameraManager, useLoaders, useInternals} = metaversefile;
...
export default () => {
  ...
  const initVector = new THREE.Vector3(0, 0, -1);
  ...
  // #################################### shockwave2 ########################################
  {
    ...
    (async () => {
      ...
      wave = await new Promise((resolve, reject) => {
