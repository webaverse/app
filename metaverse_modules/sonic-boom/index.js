...
export default () => {
  ...
  totalPlayers.forEach((currentPlayer) => {
    ...
    let lastStopSw=0;
        ...
        //         currentPlayer.getWorldDirection(dum)
        //         dum = dum.normalize();
        ...
        //{
            ...
            //     electronicball.position.copy(currentPlayer.position);
            //     currentPlayer.getWorldDirection(localVector)
            //     localVector.normalize();
            //     //console.log(dum);
            ...
            //     // if(!currentPlayer.hasAction('fly') && !currentPlayer.hasAction('jump')){
            //         if (currentPlayer.avatar) {
            //             electronicball.position.y -= currentPlayer.avatar.height;
    ...
    //                     wave.scene.position.copy(currentPlayer.position);
