...
export const decorateAnimation = animation => {
  ...
  animation.isBackward = /backwards/i.test(animation.name) || /sneaking forward reverse/i.test(animation.name) || /Standing Aim Walk Forward reverse/i.test(animation.name);
