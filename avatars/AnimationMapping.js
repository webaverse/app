class AnimationMapping {
  constructor(animationTrackName, boneName, isTop, isPosition, isCombo) {
  ...
  clone() {
    return new AnimationMapping(this.animationTrackName, this.boneName, this.isTop, this.isPosition, this.isCombo);
  }
}
...
export const animationMappingConfig = [
  ...
  new AnimationMapping('mixamorigSpine1.quaternion', 'Chest', true, false, true),
  new AnimationMapping('mixamorigSpine2.quaternion', 'UpperChest', true, false, true),
