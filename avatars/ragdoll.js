...
export const makeRagdollMesh = avatar => {
  ...
  object.createRagdoll = avatar => {
    ...
    const jointHipsSpine = physicsManager.addJoint(flatMeshes.Hips, flatMeshes.Spine,
      ...
      localQuaternion.identity(), identityQuaternion);
    ...
    const jointLeft_shoulderLeft_arm = physicsManager.addJoint(flatMeshes.Left_shoulder, flatMeshes.Left_arm,
      ...
      localQuaternion.identity().setFromEuler(localEuler.set(0, -45 * DEG2RAD, -35 * DEG2RAD)), identityQuaternion);
    ...
    const jointLeft_armLeft_elbow = physicsManager.addJoint(flatMeshes.Left_arm, flatMeshes.Left_elbow,
      ...
      localQuaternion.identity().setFromEuler(localEuler.set(0, -70 * DEG2RAD, 0)), identityQuaternion);
    ...
    const jointLeft_elbowLeft_wrist = physicsManager.addJoint(flatMeshes.Left_elbow, flatMeshes.Left_wrist,
      ...
      localQuaternion.identity().setFromEuler(localEuler.set(0, 0, 30 * DEG2RAD)), identityQuaternion);
    ...
    const jointLeft_kneeLeft_ankle = physicsManager.addJoint(flatMeshes.Left_knee, flatMeshes.Left_ankle,
      ...
      localQuaternion.identity().setFromEuler(localEuler.set(0, 0, 0)), identityQuaternion);
    ...
    //   new THREE.Quaternion().setFromEuler(localEuler.set(0, 0, 0)), new THREE.Quaternion());
  ...
  object.toAvatar = avatar => {
    ...
    getDiffQuaternion(avatar.modelBoneOutputs.Left_leg.quaternion, flatMeshes.Hips.quaternion, flatMeshes.Left_leg.quaternion);
    getDiffQuaternion(avatar.modelBoneOutputs.Spine.quaternion, flatMeshes.Hips.quaternion, flatMeshes.Spine.quaternion);
    getDiffQuaternion(avatar.modelBoneOutputs.Chest.quaternion, flatMeshes.Spine.quaternion, flatMeshes.Chest.quaternion);
    getDiffQuaternion(avatar.modelBoneOutputs.UpperChest.quaternion, flatMeshes.Chest.quaternion, flatMeshes.UpperChest.quaternion);
    getDiffQuaternion(avatar.modelBoneOutputs.Right_leg.quaternion, flatMeshes.Hips.quaternion, flatMeshes.Right_leg.quaternion);
    getDiffQuaternion(avatar.modelBoneOutputs.Left_knee.quaternion, flatMeshes.Left_leg.quaternion, flatMeshes.Left_knee.quaternion);
    getDiffQuaternion(avatar.modelBoneOutputs.Left_ankle.quaternion, flatMeshes.Left_knee.quaternion, flatMeshes.Left_ankle.quaternion);
    getDiffQuaternion(avatar.modelBoneOutputs.Right_knee.quaternion, flatMeshes.Right_leg.quaternion, flatMeshes.Right_knee.quaternion);
    getDiffQuaternion(avatar.modelBoneOutputs.Right_ankle.quaternion, flatMeshes.Right_knee.quaternion, flatMeshes.Right_ankle.quaternion);
    getDiffQuaternion(avatar.modelBoneOutputs.Left_arm.quaternion, flatMeshes.Left_shoulder.quaternion, flatMeshes.Left_arm.quaternion);
    getDiffQuaternion(avatar.modelBoneOutputs.Left_elbow.quaternion, flatMeshes.Left_arm.quaternion, flatMeshes.Left_elbow.quaternion);
    getDiffQuaternion(avatar.modelBoneOutputs.Left_wrist.quaternion, flatMeshes.Left_elbow.quaternion, flatMeshes.Left_wrist.quaternion);
    getDiffQuaternion(avatar.modelBoneOutputs.Right_arm.quaternion, flatMeshes.Right_shoulder.quaternion, flatMeshes.Right_arm.quaternion);
    getDiffQuaternion(avatar.modelBoneOutputs.Right_elbow.quaternion, flatMeshes.Right_arm.quaternion, flatMeshes.Right_elbow.quaternion);
    getDiffQuaternion(avatar.modelBoneOutputs.Right_wrist.quaternion, flatMeshes.Right_elbow.quaternion, flatMeshes.Right_wrist.quaternion);
    getDiffQuaternion(avatar.modelBoneOutputs.Neck.quaternion, flatMeshes.UpperChest.quaternion, flatMeshes.Neck.quaternion);
    getDiffQuaternion(avatar.modelBoneOutputs.Head.quaternion, flatMeshes.Neck.quaternion, flatMeshes.Head.quaternion);
  };
