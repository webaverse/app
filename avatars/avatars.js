...
class Avatar {
  ...
  update(timestamp, timeDiff) {
    ...
    this.cellphoneDrawFactor = Math.min(
      Math.max(this.cellphoneDrawTime / crouchMaxTime, 0),
      1,
    );
    this.cellphoneUndrawFactor = Math.min(
      Math.max(this.cellphoneUndrawTime / crouchMaxTime, 0),
      1,
    );
    this.swimUpFactor = Math.min(
      Math.max(this.swimUpTime / crouchMaxTime, 0),
      1,
    );
    this.swimDownFactor = Math.min(
      Math.max(this.swimDownTime / crouchMaxTime, 0),
      1,
    );
    this.surfaceFactor = Math.min(
      Math.max(this.swimmingOnSurfaceTime / crouchMaxTime, 0),
      1,
    );
