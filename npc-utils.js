...
class PathFinder {
  ...
  getPath(start, dest) {
    const positions = physicsManager.getPath(start, dest, this.voxelHeight, this.heightTolerance, this.detectStep, this.maxIterdetect, this.maxIterStep, this.maxVoxelCacheLen, this.ignorePhysicsIds);
